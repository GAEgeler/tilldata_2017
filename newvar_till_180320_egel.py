# Analysis till data: create new variables
# stand: 2.5.18 // egel
...
df1= pd.read_csv("filtered_r_clean_180502_egel.csv", sep=';', parse_dates=['date','trans_date'])
...
# saving result
df1.to_csv("filtered_r_final_180502_egel.csv", sep=';', index=False)
