...
d = pd.read_csv('joined_180320_05egel.csv', sep=';', encoding='latin1',parse_dates=['date','trans_date']).rename(columns={'price_articles':'price_article','price_payments':'price_payment'})
...
df.to_csv('filtered_py_180502_egel.csv', sep=';',encoding = 'latin1')


### filter time => see diff r_py 180417_egel for more information
...
df1.to_csv('filtered_py_time_180502_egel.csv', sep=';',encoding = 'latin1') # some information is getting lost while loading with R
