...
# see documentation: "Egeler, 2019. Dokumentation (NOVANIMAL Kurzbericht). WÃ¤denswil: ZHAW."
...
## was however not taken into account (see Egeler 2019. Dokuemnation (NOVANIMAL Kurzbericht). WÃ¤denswil: ZHAW)

###############
# adjust data set
## Kitchen
# 	2017-10-09: local tÃ¶ssfeld to kitchen in individual dataset (10x)
...
## Kitchen
# 	2017-10-09: local tÃ¶ssfeld to kitchen in individual dataset (10x)
# 	2017-10-09: local tÃ¶ssfeld to kitchen in aggregated dataset (12x)
d.loc[(d['date']=='2017-10-09') & (d['article_description']=="Local TÃ¶ssfeld"),'article_description'] ='Local Kitchen'
