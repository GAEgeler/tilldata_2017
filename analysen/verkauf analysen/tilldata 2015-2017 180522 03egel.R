...
#plot
ggplot(df_, aes(y=tot_sold,x=as.character(year), fill=factor(variable2,levels=c("Unknown","Vegan","Vegetarian","Meat","Hot and Cold")), color=label_color)) +
    geom_bar(stat="identity", position = "stack", color=NA, width = .7) +
    #ggtitle("Verkaufte Menüs: 3. + 4. HSW\n") +
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/slides template Ordner/plots/sold_autumn_de 2015-2017 180614 02egel.png",
       width = 12,
       height = 8,
       dpi=600,
       units="in",
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/slides template Ordner/plots/sold_autumn_canteen_de 2015-2017 180614 03egel.png",
       width = 16,
       height = 10,
       dpi=600,
       units="in",
