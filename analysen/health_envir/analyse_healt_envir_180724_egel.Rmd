...
```{r, echo=F, message=F, fig.width=25, fig.height=14}
####----------
...
## add some lines with (mean and sd) => for control
...
```{r, echo=F, fig.width=25, fig.height=14}
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/input_gesundheit_online_exp_indd_180704/plots/teller_order_180704_02egel.pdf",
       width = 25,
       height = 14,
       dpi = 600,
       units="in",
