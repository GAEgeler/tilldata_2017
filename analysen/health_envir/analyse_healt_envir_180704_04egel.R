...
df_ <- df %>% 
    dplyr::group_by(label_content, ebp_label) %>%
    summarise(tot=n()) %>%
...
# save plot
ggsave("S:/pools/n/N-IUNR-nova-data/02_kassendaten/01_analysen/health_envir/plots/ebp_content_180813_egel.pdf",
       width = 12,
       height = 10, 
       dpi = 600, 
       units="in",
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/input_gesundheit_online_exp_indd_180704/plots/ebp_content_180813_egel.pdf",
       width = 12,
       height = 10,
       dpi = 600,
       units="in",
...
# save plot
ggsave("S:/pools/n/N-IUNR-nova-data/02_kassendaten/01_analysen/health_envir/plots/teller_content_180813_egel.pdf",
       width = 8.27,
       height = 11.69, 
       dpi = 600, 
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/input_gesundheit_online_exp_indd_180704/plots/teller_content_180813_egel.pdf",
       width = 14,
       height = 10, 
       dpi = 600,
       units="in",
