...
os.chdir('S:/pools/n/N-IUNR-nova-data/02_kassendaten/00_original/Versand an ZHAW/files')
df1= pd.read_csv("filtered_data_dub_180320_05egel.csv", sep=';',encoding = 'latin1', parse_dates=['date','trans_date']).rename(columns={'article_description':'art_description'})

df1= pd.read_csv("filtered_data_dub_notime_180320_05egel.csv", sep=',', parse_dates=['date','trans_date']).rename(columns={'article_description':'art_description'})
...
# saving result
df1.to_csv("filtered_data_r_180403_egel.csv", sep=';',encoding = 'latin1', index=False)
df1.to_csv("filtered_data_r_notime_180403_egel.csv", sep=';', index=False)
