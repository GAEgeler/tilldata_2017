...
menu_tot <- read_delim("S:/pools/n/N-IUNR-nova-data/02_kassendaten/01_analysen/ist soll analyse/all data daily 15_17 180620 egel.csv",delim = ';')
...
menu_tot_ <- bind_rows(df_tot, menu_tot7_)
