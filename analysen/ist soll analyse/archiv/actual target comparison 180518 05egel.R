...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/ppp_indd_180627/plots/actual_target_comp_condition_locals_de 2017 180615 04egel.pdf",
              width = 17,
              height = 9,
              dpi = 600,
              units="in",
...
ggplot(df_, aes(y=tot,x=xlab, fill=factor(label_content,levels=c("Unknown","Vegan","Vegan+","Vegetarian","Meat","Hot and Cold")), color=label_color)) +
    ...
    geom_text(aes(label=ifelse(pct*100>3,paste(round(pct*100,digits = 1),"%", sep = ""),"")),size = 5, position = position_stack(vjust = 0.5))+ #omit numbers to be shown smaller than 190
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/ppp_indd_180627/plots/actual_target_comp_menu_offer 2015-2017 180615 04egel.pdf",
              width = 17,
              height = 9,
              dpi = 600,
              units="in",
...
ggplot(df_, aes(y=tot,x=xlab, fill=factor(label_content,levels=c("Unknown","Vegan","Vegan+","Vegetarian","Meat","Hot and Cold")), color=label_color)) +
    ...
    geom_text(aes(label=ifelse(pct*100>2,paste(round(pct*100,digits = 1),"%",""),"")),size = 5, position = position_stack(vjust = 0.5))+ #omit numbers to be shown smaller than 190
...
######
## save plots for presantation somewhere else
ggsave("S:/pools/n/N-IUNR-Allgemein/Zentren/gruppe_NOVA/04_f&e/97103165041001_NOVANIMAL_arbeit/12_work_pack/wpIII.1_menu_choice/05_besprechungen/180706_sv_fm_meeting/ppp_indd_180627/plots/actual_target_menu_offer 2017 180614 04egel.pdf",
              width = 17,
              height = 9,
              dpi = 600,
              units="in",
