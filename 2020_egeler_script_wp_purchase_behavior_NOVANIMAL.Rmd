...
# plot 
p <- ggplot(visiter_freq, aes(x = category, y = pct)) +
    geom_bar(stat="identity",colour=NA, position = position_dodge(width = NULL), width = .5, fill = "#fad60d")+
...
### Häufigkeit Mensabesuche: Geschlecht x Hochschulzugehörigkeit
...
treemap(dat, #Your data frame object
        ...
        algorithm = "pivotSize",
        sortID = "test2",
        fontfamily.labels = "sans") # figure 12
